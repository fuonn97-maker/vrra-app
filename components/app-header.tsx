      ...
      <div className="max-w-md mx-auto px-6 py-4 flex items-center justify-between gap-4">
        ...
        {isPremium && (
          <button
            ...
            className="flex-1 flex items-center justify-center gap-1.5 px-3 py-1.5 bg-primary/10 hover:bg-primary/20 border border-primary/20 rounded-full text-primary text-sm font-semibold transition-colors"
            ...
            <div className="absolute right-0 mt-2 bg-card border border-border/30 rounded-lg shadow-lg min-w-48 z-50">
              ...
              <div className="px-4 py-3 border-b border-border/20">
                <div className="flex items-center gap-2">
                  <Crown
                    size={14}
                    className={isPremium ? 'text-primary' : 'text-accent'}
                  />
                  <span
